...
public class HarmonyOfTasteItems {
    ...
    public static final DeferredItem<Item> RAW_GOAT_MEAT = ITEMS.registerSimpleItem("raw_goat_meat", new Item.Properties().food(new FoodProperties.Builder().nutrition(3).saturationModifier(0.2f).build()));
    public static final DeferredItem<Item> COOKED_GOAT_MEAT = ITEMS.registerSimpleItem("cooked_goat_meat", new Item.Properties().food(new FoodProperties.Builder().nutrition(7).saturationModifier(0.7f).build()));
